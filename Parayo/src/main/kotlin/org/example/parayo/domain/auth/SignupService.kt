...
import org.example.parayo.common.ParayoException
import org.example.parayo.domain.user.User
import org.example.parayo.domain.user.UserRepository
...
class SignupService @Autowired constructor(private val userRepository: UserRepository) {
    ...
    private fun resisterUser(signupRequest: SignupRequest) = with(signupRequest) {
